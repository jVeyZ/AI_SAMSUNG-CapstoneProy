...
object L {
    ...
    private val UI_EN = mapOf(
        ...
        "error_bad_image" to "Unsupported image type. Use JPG or PNG.",
    ...
    private val UI_ES = mapOf(
        ...
        "error_bad_image" to "Tipo de imagen no compatible. Usa JPG o PNG.",
    ...
    private val UI_VA = mapOf(
        ...
        "error_bad_image" to "Tipus d'imatge no compatible. Usa JPG o PNG.",
